...
st.set_page_config(page_title="Chatbot IA Emocional (LLaMA 3 - 70B)", layout="centered")
        ...
        with st.spinner("Pensando..."):
            ...
            try:
                response = requests.post(API_URL, headers=headers, json={
                    "version": "fcb5dca25c931e1d8f6f87ecbb6f2de0fb9f56ac837b1263e0ce1b9c5533feda",
                    "input": {
                        "prompt": prompt,
                        "temperature": 0.7,
                        "top_p": 0.9,
