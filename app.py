...
st.set_page_config(page_title="Chatbot IA Emocional (LLaMA 3 STREAM FIX)", layout="centered")
    ...
    with st.chat_message("assistant"):
        with st.spinner("Pensando..."):
            ...
            try:
                ...
                output = f"Erro ao acessar Replicate: {e}"
                st.error(output)

    st.session_state.history.append(("assistant", output.strip()))
